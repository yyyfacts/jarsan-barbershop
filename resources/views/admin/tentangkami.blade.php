        ...
        <div class="row g-4">
            <div class="col-12 col-lg-6">
                <div class="card h-100 p-4">
                    ...
                    <div class="mb-3">
                        <label class="form-label text-secondary small">TEXT</label>
                        <textarea name="history" rows="8" class="form-control">{{ $about->history ?? '' }}</textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label text-secondary small">IMAGE</label>
                        <input type="file" name="history_image" class="form-control">
                    </div>
                    @if($about->history_image)
                        <img src="{{ $about->history_image }}" class="img-fluid rounded border border-secondary mt-2">
                    @endif
                </div>
            </div>
            <div class="col-12 col-lg-6">
                <div class="card h-100 p-4">
                    ...
                    <div class="mb-3">
                        <label class="form-label text-secondary small">TEXT</label>
                        <textarea name="mission" rows="8" class="form-control">{{ $about->mission ?? '' }}</textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label text-secondary small">IMAGE</label>
                    ...
                    @if($about->mission_image)
                        <img src="{{ $about->mission_image }}" class="img-fluid rounded border border-secondary mt-2">
                    @endif
                </div>
            </div>
        </div>
