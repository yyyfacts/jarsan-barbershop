...
<div class="row g-4 justify-content-center">
    <div class="col-12 col-md-4">
        <div class="card h-100 p-4 text-center">
            <div class="card-body">
                <div class="mb-3" style="color: var(--gold-accent);"><i class="bi bi-calendar-check fs-1"></i></div>
    ...
    <div class="col-12 col-md-4">
        <div class="card h-100 p-4 text-center">
            <div class="card-body">
                <div class="mb-3" style="color: var(--gold-accent);"><i class="bi bi-scissors fs-1"></i></div>
    ...
    <div class="col-12 col-md-4">
        <div class="card h-100 p-4 text-center">
            <div class="card-body">
                <div class="mb-3" style="color: var(--gold-accent);"><i class="bi bi-people fs-1"></i></div>
