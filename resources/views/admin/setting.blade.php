...
<div class="text-center mb-5">
    ...
    <p class="small" style="color: var(--text-muted);">Sesuaikan identitas dan logo aplikasi.</p>
</div>
...
<div class="row justify-content-center">
    <div class="col-12 col-md-6">
        <div class="card border-0 shadow-sm rounded-3">
            <div class="card-header bg-transparent border-bottom py-3" style="border-color: var(--border-color);">
                <h6 class="fw-bold m-0 text-uppercase small" style="color: var(--text-muted);"><i
                        class="bi bi-gear-fill me-2"></i>Edit Identitas</h6>
            </div>
            <div class="card-body p-4">
                <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label class="form-label small fw-bold" style="color: var(--text-muted);">NAMA WEBSITE</label>
                        <div class="input-group">
                            <span class="input-group-text bg-light border-end-0"
                                style="border-color: var(--border-color);"><i class="bi bi-globe"></i></span>
                    ...
                    <div class="mb-4">
                        <label class="form-label small fw-bold" style="color: var(--text-muted);">UPLOAD LOGO
                            BARU</label>
                        <input type="file" name="logo" class="form-control" accept="image/*">
                        <div class="form-text small mt-1" style="color: var(--text-muted);"><i
                                class="bi bi-info-circle me-1"></i>Format JPG/PNG, Maksimal 2MB.</div>
                    </div>

                    <hr class="my-4 opacity-25" style="border-color: var(--border-color);">
