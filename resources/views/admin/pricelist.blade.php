...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="small" style="color: var(--text-muted);">Daftar paket layanan yang tersedia.</p>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="small text-truncate" style="max-width: 200px; color: var(--text-muted);">
                                {{ $service->description }}</div>
                        </td>
                        <td style="color: var(--text-muted);">{{ $service->duration_minutes }} Menit</td>
                        <td class="fw-bold" style="color: var(--gold-primary);">Rp
                            ...
                            <div class="modal-content">
                                ...
                                <form action="{{ route('admin.services.update', $service->id) }}" method="POST"
                                    ...
                                    <div class="modal-footer border-top" style="border-color: var(--border-color);">
                                        <button type="submit" class="btn btn-gold w-100">Update Layanan</button>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="mb-3"><label class="form-label small fw-bold" style="color: var(--text