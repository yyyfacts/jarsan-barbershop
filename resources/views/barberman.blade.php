...
<section class="py-5 mt-5" style="background-color: #050505;">
    <div class="container py-5 text-center">
        ...
        {{-- 1. SUB-JUDUL DINAMIS (Dari Database) --}}
        <h5 class="text-gold letter-spacing-5 mb-2 fw-bold" data-aos="fade-down">
            {{ $pageConfig->barber_subtitle ?? 'MEET THE ARTISTS' }}
        </h5>

        {{-- 2. JUDUL UTAMA DINAMIS (Dari Database) --}}
        {{-- Pakai {!! !!} biar bisa render HTML seperti <span> --}}
        <h2 class="display-4 fw-bold text-white mb-5" style="font-family: 'Playfair Display', serif;"
            data-aos="fade-up">
            {!! $pageConfig->barber_title ?? 'MASTER OF <span class="fst-italic text-gold">PRECISION</span>' !!}
        </h2>
