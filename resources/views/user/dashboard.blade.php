                ...
                <table class="table table-luxury align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="fw-bold text-white d-block">{{ $res->service->name ?? 'Layanan' }}</span>
                        ...
                        <tr>
                            <td colspan="4" class="text-center py-5">
                                <div class="d-flex flex-column align-items-center justify-content-center">
                                    <i class="bi bi-scissors display-4 text-white-50 mb-3" style="opacity: 0.3;"></i>
