...
/* --- PERBAIKAN MODAL (Mencegah layar beku) --- */
.modal-backdrop {
...
<div class="container py-5" style="margin-top: 100px; margin-bottom: 120px;">
    ...
    <div class="row g-5">
                ...
                <div class="text-center position-relative z-index-1">
                    <div class="mb-4 position-relative d-inline-block">
                        <img src="{{ Auth::user()->avatar_blob ?? 'https://ui-avatars.com/api/?name='.urlencode(Auth::user()->name).'&background=D4AF37&color=000' }}"
                            ...
                            style="width: 120px; height: 120px; object-fit: cover; border: 2px solid var(--luxury-gold); padding: 4px;">
                    ...
                    <span class="text-gold small letter-spacing-2 text-uppercase opacity-75">Anggota Elite</span>

                    <div class="mt-4 mb-4 d-flex justify-content-center gap-2">
                        <div class="flex-fill stats-box p-3">
                            <h4 class="m-0 text-white fw-bold">
                                {{ Auth::user()->reservations()->where('status', 'done')->count() }}</h4>
                            <small class="text-gold opacity-75 small">Kunjungan</small>
                        </div>
                        <div class="flex-fill stats-box p-3">
                            <h4 class="m-0 text-white fw-bold">Level</h4>
                            <small class="text-gold opacity-75 small">Gold</small>
                        </div>
                    </div>

                    <p class="text-white-50 small mb-4 fst-italic">"Penampilan adalah cerminan kepribadian Anda."</p>

                    <a href="{{ route('profile.edit') }}" class="btn btn-gold-luxury w-100 py-2 fw-bold">
                        PENGATURAN AKUN
                    </a>
                </div>
            </div>
        ...
        {{-- BAGIAN KANAN: RIWAYAT LAYANAN --}}
        <div class="col-lg-8" data-aos="fade-left">
            <div class="p-4 p-md-5" style="background: #111; border: 1px solid #222;">
                <div class="d-flex justify-content-between align-items-end mb-4">
                    <div>
                        <h6 class="text-gold letter-spacing-2 mb-1">RIWAYAT</h6>
                        <h4 class="text-white fw-bold m-0">DAFTAR KUNJUNGAN</h4>
                    </div>
                    <i class="bi bi-clock-history text-gold fs-3"></i>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    @elseif($hasReview)
                                    <div class="mt-1">
                                        <small class="text-white-50 fst-italic" style="font-size: 0.7rem;">Ulasan telah
                                            dikirim</small>
                                    </div>
                                    @endif
                                </td>
                            ...
                            <tr>
                                <td colspan="4" class="text-center py-5">
                                    <i class="bi bi-calendar-x text-white-50 fs-1 d-block mb-3"></i>
                                    <p class="text-white-50 small">BELUM ADA RIWAYAT KUNJUNGAN</p>
                                    <a href="{{ route('reservasi') }}"
                                        class="btn btn-sm btn-outline-warning mt-2 px-4 rounded-0">PESAN JADWAL</a>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
